...
def create_hist_for_key(key: str) -> Hist:
    ...
    """
    # If you want special ranges for certain keys, do something like:
    # if key == "dis_xbj":
    #     return Hist.new.Regular(100, 0, 1, name="value").Double()
    # elif key == "dis_q2":
    #     return Hist.new.Regular(100, 0, 100, name="value").Double()
    #
    # Fallback generic:
